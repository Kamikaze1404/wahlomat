...
const descriptionHeading1 = "Bundestagswahl";


// 	1.6.3. Zweite Ueberschrift / 1.6.2. Second Headline

const descriptionHeading2 = "Die Wahl zur neuen Regierung in Deutschland";


// 	1.6.4. Kurzer Text um was es bei der Wahl geht / 1.6.3. Short (descriptive) text on what's the election about
const descriptionExplanation = "ACHTUNG, BITTE LESEN: Der Wahl-O-Mat ist ein Produkt, welches im Rahmen einer wissenschaftlichen Projektarbeit im Studium an der HSU Hamburg entstanden ist. Es geht um die politische Wirkung von KI und die Frage, wie eine demokratische Gesellschaft der Zukunft gestaltet werden muss, um diesem wachsenden Einfluss zu begegnen. Zur Veranschaulichung dieses Einflusses von KI finden Sie im Folgenden KI-generierte Inhalte. Diese Inhalte spiegeln NICHT die Meinung des Teams, der Helmut-Schmidt-Universität oder der Bundeswehr wider. Wir Produzenten des Wahl-O-Mats distanzieren uns ausdrücklich von allen generierten Inhalten und möglichen Interpretationen. Die Verwendung des Materials durch Dritte wird untersagt. Das Ziel des Wahl-O-Mats und der generierten Inhalte ist vielmehr zu zeigen, wie schnell solche und ähnliche Inhalte unreguliert, ohne technische Vorkenntnisse und kostenfrei erstellt werden können. Die Intention dieses Projekts ist es entsprechend, ein Bewusstsein für die Herausforderungen und Risiken zu schaffen, die mit der automatisierten Generierung von politischen Inhalten verbunden sind.";
